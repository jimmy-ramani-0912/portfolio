import{r as R,u as Yt,a as bt,o as gt,j as o,d as we,i as je,H as y,c as Ce,g as _e,B as nt,s as Te,b as Jt,p as zt,e as X,f as K,h as Y,k as Nt,l as Z,m as et,n as tt,q as G,t as Ee,R as Oe,v as Xt,w as Kt,x as ke,y as wt,z as $e,T as Se,A as Me}from"./index-BrUZ47WH.js";import{C as Re,W as Ae,T as De,D as Pe,a as Le,b as rt,c as Ht,d as ze,P as It,V as Ne,i as He}from"./index-8HaRJxOb.js";import{e as Ie,u as Zt,T as Fe,r as Ue,g as Ft,a as Be}from"./CloseRounded-lsb9C6ks.js";import{B as We,I as Ge}from"./BlogCards-DMTSdHYw.js";import{C as qe,W as Ve,T as Qe,D as Ye,a as Je,V as Xe}from"./BlogsStyle-zDvTq7Nw.js";function Ut(t){return t.substring(2).toLowerCase()}function Ke(t,r){return r.documentElement.clientWidth<t.clientX||r.documentElement.clientHeight<t.clientY}function Ze(t){const{children:r,disableReactTree:p=!1,mouseEvent:x="onClick",onClickAway:j,touchEvent:h="onTouchEnd"}=t,C=R.useRef(!1),n=R.useRef(null),a=R.useRef(!1),e=R.useRef(!1);R.useEffect(()=>(setTimeout(()=>{a.current=!0},0),()=>{a.current=!1}),[]);const i=Yt(r.ref,n),l=bt(d=>{const f=e.current;e.current=!1;const m=gt(n.current);if(!a.current||!n.current||"clientX"in d&&Ke(d,m))return;if(C.current){C.current=!1;return}let v;d.composedPath?v=d.composedPath().indexOf(n.current)>-1:v=!m.documentElement.contains(d.target)||n.current.contains(d.target),!v&&(p||!f)&&j(d)}),c=d=>f=>{e.current=!0;const m=r.props[d];m&&m(f)},s={ref:i};return h!==!1&&(s[h]=c(h)),R.useEffect(()=>{if(h!==!1){const d=Ut(h),f=gt(n.current),m=()=>{C.current=!0};return f.addEventListener(d,l),f.addEventListener("touchmove",m),()=>{f.removeEventListener(d,l),f.removeEventListener("touchmove",m)}}},[l,h]),x!==!1&&(s[x]=c(x)),R.useEffect(()=>{if(x!==!1){const d=Ut(x),f=gt(n.current);return f.addEventListener(d,l),()=>{f.removeEventListener(d,l)}}},[l,x]),o.jsx(R.Fragment,{children:R.cloneElement(r,s)})}function tn(t){const{autoHideDuration:r=null,disableWindowBlurListener:p=!1,onClose:x,open:j,resumeHideDuration:h}=t,C=R.useRef();R.useEffect(()=>{if(!j)return;function v(g){g.defaultPrevented||(g.key==="Escape"||g.key==="Esc")&&(x==null||x(g,"escapeKeyDown"))}return document.addEventListener("keydown",v),()=>{document.removeEventListener("keydown",v)}},[j,x]);const n=bt((v,g)=>{x==null||x(v,g)}),a=bt(v=>{!x||v==null||(clearTimeout(C.current),C.current=setTimeout(()=>{n(null,"timeout")},v))});R.useEffect(()=>(j&&a(r),()=>{clearTimeout(C.current)}),[j,r,a]);const e=v=>{x==null||x(v,"clickaway")},i=()=>{clearTimeout(C.current)},l=R.useCallback(()=>{r!=null&&a(h??r*.5)},[r,h,a]),c=v=>g=>{const b=v.onBlur;b==null||b(g),l()},s=v=>g=>{const b=v.onFocus;b==null||b(g),i()},d=v=>g=>{const b=v.onMouseEnter;b==null||b(g),i()},f=v=>g=>{const b=v.onMouseLeave;b==null||b(g),l()};return R.useEffect(()=>{if(!p&&j)return window.addEventListener("focus",l),window.addEventListener("blur",i),()=>{window.removeEventListener("focus",l),window.removeEventListener("blur",i)}},[p,l,j]),{getRootProps:(v={})=>{const b={...Ie(t),...v};return{role:"presentation",...b,onBlur:c(b),onFocus:s(b),onMouseEnter:d(b),onMouseLeave:f(b)}},onClickAway:e}}const en=t=>{var r,p;const x={systemProps:{},otherProps:{}},j=(r=t==null||(p=t.theme)==null?void 0:p.unstable_sxConfig)!=null?r:we;return Object.keys(t).forEach(h=>{j[h]?x.systemProps[h]=t[h]:x.otherProps[h]=t[h]}),x};function nn(t){const{sx:r,...p}=t,{systemProps:x,otherProps:j}=en(p);let h;return Array.isArray(r)?h=[x,...r]:typeof r=="function"?h=(...C)=>{const n=r(...C);return je(n)?{...x,...n}:x}:h={...x,...r},{...j,sx:h}}const on=y.div`
    width:600px;
    height: 500px;
...
`,Rr=y.div`
    ...
    justify-content: center;
    gap: 12px;
`,Ar=()=>o.jsx(kr,{id:"experience",children:o.jsxs($r,{children:[o.jsx(Sr,{children:"Experience"}),o.jsx(Mr,{children:"My work experience as a software engineer and working on different companies and projects."}),o.jsx(Rr,{children:o.jsx(Tt,{children:wt.map((t,r)=>o.jsxs(Ot,{children:[o.jsxs(kt,{children:[o.jsx(St,{variant:"outlined",color:"secondary"}),r!==wt.length-1&&o.jsx($t,{style:{background:"#854CE6"}})]}),o.jsx(Et,{sx:{py:"12px",px:2},children:o.jsx(Or,{experience:t})})]}))})})]})}),Dr=y.img`
  display: none;
  height: 70px;
  width: fit-content;
  background-color: #000;
...
`,Br=({education:t,hasImage:r})=>{const p=y.div`
    ...
    display: flex;
    gap: ${r?"12px":"0"};
  `;return o.jsxs(Lr,{children:[o.jsxs(p,{children:[o.jsx(zr,{src:t.img}),o.jsxs(Nr,{children:[o.jsx(Hr,{children:t.school}),o.jsx(Ir,{children:t.degree}),o.jsx(Fr,{children:t.date})]})]}),o.jsxs(Ur,{children:[o.jsx("b",{children:"Grade: "}),t.grade]}),o.jsx(Pr,{children:o.jsx(ue,{children:t.desc})})]})},Wr=y.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  position: relative;
...
`,Yr=()=>o.jsx(Wr,{id:"education",children:o.jsxs(Gr,{children:[o.jsx(qr,{children:"Education"}),o.jsx(Vr,{children:"My education has been a journey of self-discovery and growth. My educational details are as follows."}),o.jsx(Qr,{children:o.jsx(Tt,{children:$e.map((t,r)=>o.jsxs(Ot,{children:[o.jsx(Et,{sx:{py:"12px",px:2},children:o.jsx(Br,{education:t,hasImage:!!t.img})}),o.jsxs(kt,{children:[o.jsx(St,{variant:"outlined",color:"secondary"}),r!==wt.length&&o.jsx($t,{style:{background:"#854CE6"}})]})]}))})})]})}),Jr=y.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  position: relative;
...
`,ei=y.div`
  ...
  font-weight: 500;
  color: ${({theme:t})=>t.text_primary};
`,ni=()=>o.jsx(Jr,{id:"education",children:o.jsxs(Xr,{children:[o.jsx(Kr,{children:"TimeLine"}),o.jsx(Zr,{children:"My journey in the tech world has been full of learning and growth."}),o.jsx(ti,{children:o.jsx(Tt,{position:"alternate",children:Se.map((t,r)=>o.jsxs(Ot,{children:[o.jsx(Ko,{color:"#854CE6",children:t.year}),o.jsxs(kt,{children:[o.jsx(St,{variant:"outlined",color:"secondary"}),o.jsx($t,{style:{background:"#854CE6"}})]}),o.jsx(Et,{children:o.jsx(ei,{children:t.text})})]}))})})]})}),oi=({openBlogModal:t,setOpenBlogModal:r})=>{const p=Jt();return o.jsx(qe,{id:"blogs",children:o.jsxs(Ve,{children:[o.jsx(Qe,{children:"Blogs"}),o.jsx(Ye,{children:"Join me as I share insights from my journey developing web and Android apps."}),o.jsx(Je,{children:Me.slice(0,5).map(x=>o.jsx(We,{blog:x,openModal:t,setOpenModal:r},x.id))}),o.jsx(Xe,{onClick:()=>{p("portfolio/blogs")},children:"View All"})]})})},ri=y.div`
...
`,pi=()=>{const[t,r]=R.useState({state:!1,project:null}),[p,x]=R.useState({state:!1,blog:null});return o.jsxs(ri,{children:[o.jsx(bn,{}),o.jsxs(Qt,{children:[o.jsx(Mn,{}),o.jsx(Ar,{})]}),o.jsx(Rn,{openModal:t,setOpenModal:r}),o.jsx(Yr,{}),o.jsx(oi,{openBlogModal:p,setOpenBlogModal:x}),o.jsxs(Qt,{children:[o.jsx(ni,{}),o.jsx(vo,{})]}),o.jsx(Po,{}),t.state&&o.jsx(He,{openModal:t,setOpenModal:r}),p.state&&o.jsx(Ge,{openBlogModal:p,setOpenBlogModal:x})]})};export{pi as default};
