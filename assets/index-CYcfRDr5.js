...
`;function Do(){return o.jsx(So,{children:o.jsxs($o,{children:[o.jsx(Mo,{children:"Jimmy Ramani"}),o.jsxs(Ro,{children:[o.jsx(at,{href:"#about",children:"About"}),o.jsx(at,{href:"#skills",children:"Skills"}),o.jsx(at,{href:"#experience",children:"Experience"}),o.jsx(at,{href:"#projects",children:"Projects"}),o.jsx(at,{href:"#education",children:"Education"})]}),o.jsxs(Ao,{children:[o.jsx(dt,{href:nt.linkedin,target:"display",children:o.jsx(ie,{})}),o.jsx(dt,{href:nt.codepen,target:"display",children:o.jsx(Vt,{src:"https://www.svgrepo.com/show/353582/codepen-icon.svg"})}),o.jsx(dt,{href:nt.medium,target:"display",children:o.jsx(Vt,{src:"https://www.svgrepo.com/show/354057/medium-icon.svg"})}),o.jsx(dt,{href:nt.insta,target:"display",children:o.jsx(se,{})})]}),o.jsx(Po,{children:"© 2024 Jimmy Ramani. All rights reserved."})]})})}const Lo=R.createContext({}),lt=Lo;function zo(t){return X("MuiTimeline",t)}Z("MuiTimeline",["root","positionLeft","positionRight","positionAlternate"]);const No=t=>{const{position:r,classes:p}=t,x={root:["root",r&&`position${G(r)}`]};return tt(x,zo,p)},Ho=Y("ul",{name:"MuiTimeline",slot:"Root",overridesResolver:(t,r)=>{const{ownerState:p}=t;return[r.root,p.position&&r[`position${G(p.position)}`]]}})({display:"flex",flexDirection:"column",padding:"6px 16px",flexGrow:1}),Fo=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimeline"}),{position:j="right",className:h,...C}=x,n={...x,position:j},a=No(n),e=R.useMemo(()=>({position:j}),[j]);return o.jsx(lt.Provider,{value:e,children:o.jsx(Ho,{className:et(a.root,h),ownerState:n,ref:p,...C})})}),Tt=Fo;function Io(t){return X("MuiTimelineContent",t)}const Uo=Z("MuiTimelineContent",["root","positionLeft","positionRight","positionAlternate"]),Bo=Uo,Wo=t=>{const{position:r,classes:p}=t,x={root:["root",`position${G(r)}`]};return tt(x,Io,p)},Go=Y(oe,{name:"MuiTimelineContent",slot:"Root",overridesResolver:(t,r)=>{const{ownerState:p}=t;return[r.root,r[`position${G(p.position)}`]]}})(({ownerState:t})=>({flex:1,padding:"6px 16px",textAlign:"left",...t.position==="left"&&{textAlign:"right"}})),qo=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimelineContent"}),{className:j,...h}=x,{position:C}=R.useContext(lt),n={...x,position:C||"right"},a=Wo(n);return o.jsx(Go,{component:"div",className:et(a.root,j),ownerState:n,ref:p,...h})}),Et=qo;function Vo(t){return X("MuiTimelineOppositeContent",t)}const Qo=Z("MuiTimelineOppositeContent",["root","positionLeft","positionRight","positionAlternate"]),Yo=Qo,Jo=t=>{const{position:r,classes:p}=t,x={root:["root",`position${G(r)}`]};return tt(x,Vo,p)},Xo=Y(oe,{name:"MuiTimelineOppositeContent",slot:"Root",overridesResolver:(t,r)=>{const{ownerState:p}=t;return[r.root,r[`position${G(p.position)}`]]}})(({ownerState:t})=>({padding:"6px 16px",marginRight:"auto",textAlign:"right",flex:1,...t.position==="left"&&{textAlign:"left"}})),ce=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimelineOppositeContent"}),{className:j,...h}=x,{position:C}=R.useContext(lt),n={...x,position:C||"left"},a=Jo(n);return o.jsx(Xo,{component:"div",className:et(a.root,j),ownerState:n,ref:p,...h})});ce.muiName="TimelineOppositeContent";const Zo=ce;function Ko(t){return X("MuiTimelineItem",t)}Z("MuiTimelineItem",["root","positionLeft","positionRight","positionAlternate","missingOppositeContent"]);const tr=t=>{const{position:r,classes:p,hasOppositeContent:x}=t,j={root:["root",`position${G(r)}`,!x&&"missingOppositeContent"]};return tt(j,Ko,p)},er=Y("li",{name:"MuiTimelineItem",slot:"Root",overridesResolver:(t,r)=>{const{ownerState:p}=t;return[r.root,r[`position${G(p.position)}`]]}})(({ownerState:t})=>({listStyle:"none",display:"flex",position:"relative",minHeight:70,...t.position==="left"&&{flexDirection:"row-reverse"},...t.position==="alternate"&&{"&:nth-of-type(even)":{flexDirection:"row-reverse",[`& .${Bo.root}`]:{textAlign:"right"},[`& .${Yo.root}`]:{textAlign:"left"}}},...!t.hasOppositeContent&&{"&:before":{content:'""',flex:1,padding:"6px 16px"}}})),nr=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimelineItem"}),{position:j,className:h,...C}=x,{position:n}=R.useContext(lt);let a=!1;R.Children.forEach(x.children,c=>{ke(c,["TimelineOppositeContent"])&&(a=!0)});const e={...x,position:j||n||"right",hasOppositeContent:a},i=tr(e),l=R.useMemo(()=>({position:e.position}),[e.position]);return o.jsx(lt.Provider,{value:l,children:o.jsx(er,{className:et(i.root,h),ownerState:e,ref:p,...C})})}),Ot=nr;function or(t){return X("MuiTimelineSeparator",t)}Z("MuiTimelineSeparator",["root"]);const rr=t=>{const{classes:r}=t;return tt({root:["root"]},or,r)},ir=Y("div",{name:"MuiTimelineSeparator",slot:"Root",overridesResolver:(t,r)=>r.root})({display:"flex",flexDirection:"column",flex:0,alignItems:"center"}),ar=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimelineSeparator"}),{className:j,...h}=x,C=x,n=rr(C);return o.jsx(ir,{className:et(n.root,j),ownerState:C,ref:p,...h})}),kt=ar;function sr(t){return X("MuiTimelineConnector",t)}Z("MuiTimelineConnector",["root"]);const lr=t=>{const{classes:r}=t;return tt({root:["root"]},sr,r)},cr=Y("span",{name:"MuiTimelineConnector",slot:"Root",overridesResolver:(t,r)=>r.root})(({theme:t})=>({width:2,backgroundColor:(t.vars||t).palette.grey[400],flexGrow:1})),pr=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimelineConnector"}),{className:j,...h}=x,C=x,n=lr(C);return o.jsx(cr,{className:et(n.root,j),ownerState:C,ref:p,...h})}),St=pr;function dr(t){return X("MuiTimelineDot",t)}Z("MuiTimelineDot",["root","filled","outlined","filledGrey","outlinedGrey","filledPrimary","outlinedPrimary","filledSecondary","outlinedSecondary"]);const ur=t=>{const{color:r,variant:p,classes:x}=t,j={root:["root",p,r!=="inherit"&&`${p}${G(r)}`]};return tt(j,dr,x)},xr=Y("span",{name:"MuiTimelineDot",slot:"Root",overridesResolver:(t,r)=>{const{ownerState:p}=t;return[r.root,r[p.color!=="inherit"&&`${p.variant}${G(p.color)}`],r[p.variant]]}})(({ownerState:t,theme:r})=>({display:"flex",alignSelf:"baseline",borderStyle:"solid",borderWidth:2,padding:4,borderRadius:"50%",boxShadow:(r.vars||r).shadows[1],margin:"11.5px 0",...t.variant==="filled"&&{borderColor:"transparent",...t.color!=="inherit"&&{...t.color==="grey"?{color:(r.vars||r).palette.grey[50],backgroundColor:(r.vars||r).palette.grey[400]}:{color:(r.vars||r).palette[t.color].contrastText,backgroundColor:(r.vars||r).palette[t.color].main}}},...t.variant==="outlined"&&{boxShadow:"none",backgroundColor:"transparent",...t.color!=="inherit"&&{...t.color==="grey"?{borderColor:(r.vars||r).palette.grey[400]}:{borderColor:(r.vars||r).palette[t.color].main}}}})),fr=R.forwardRef(function(r,p){const x=K({props:r,name:"MuiTimelineDot"}),{className:j,color:h="grey",variant:C="filled",...n}=x,a={...x,color:h,variant:C},e=ur(a);return o.jsx(xr,{className:et(e.root,j),ownerState:a,ref:p,...n})}),$t=fr,pe=y.img`
  display: none;
  height: 70px;
  width: fit-content;
